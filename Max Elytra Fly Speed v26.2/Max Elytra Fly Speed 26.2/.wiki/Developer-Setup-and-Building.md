# Developer Setup, Building & Automated Testing — MC 26.2

This guide provides instructions for compiling release JARs and running automated JUnit tests for **Max Elytra Fly Speed (MC 26.2)**.
